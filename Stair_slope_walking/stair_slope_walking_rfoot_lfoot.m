function stair_slope_walking_rfoot_lfoot()
% two feet trajectory estimation of square walking: yes
close all
clear all
addpath(genpath('D:\Work\Task\imu_Code\imu-Matlab'));
addpath(genpath('D:\AfterPhD\research\FootTrajectoryEstimation\data_Xsens\SynchronizationAndVisualization\stair_slope\data'));
load('IMU_STAIR_SLOPE_1.mat')
